...
- Dizziness that doesn't resolve after resting 2 minutes
- Nausea during or immediately after
- Visual disturbances worsen
- "Foggy" feeling significantly worse than pre-exercise within 1 hour

These are signs the brain is being pushed past its current recovery threshold. Drop intensity 30% and rebuild.
